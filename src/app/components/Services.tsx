  ...
  return (
    <div className="p-4 bg-[var(--color-bg)]">
      <div className="flex flex-col justify-center items-center gap-2 mb-6">
        <h1 className="text-4xl font-bold font-luckiest text-center text-[var(--color-text)] mt-10">
          Our Services
        </h1>
      ...
      <div className=" ">
        <div className="flex flex-wrap items-center justify-center gap-4 key={index}">
          {data.map((item, index) => (
            <div
              key={index}
              className="w-full md:w-[30%] p-4 bg-white shadow text-[var(--color-bg)] md:h-[31rem]   "
            >
              <div className="h-[14rem] md:h-[10rem]   ">
                <Image
                  src={item.imageUrl}
                  alt="Item Image"
                  width={300}
              ...
              <div className="font-gelasio">
                ...
                <p className="   text-[var(--color-bg-variant)] leading-6">
                  {item.comment}
                </p>
              </div>
            </div>
